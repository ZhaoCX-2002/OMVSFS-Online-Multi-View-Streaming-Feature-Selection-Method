...
function [CI,SS,dep1]=optimal_compter_dep_21(bcf,var,target,max_k, discrete, alpha, test,data,node)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while stop==0
           ...
           for i=1:cond_size
            ...
            cond=unique(cond);
            if discrete==1
                 [CI, SS,dep, alpha2]=my_cond_indep_chisquare(data,var,target,cond,test,alpha);
                 x=dep;
            else 
                 [CI, SS,r, p]= my_cond_indep_fisher_z(data,var,target, cond, N, alpha);
                 x=r;
            end           
